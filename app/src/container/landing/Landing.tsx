              ...
              <div className="md:col-span-7 xl:col-span-8 col-span-12">
                <div className="my-6">
                  <h2 className="font-semibold mb-4 text-[2rem]">
                    ...
                    <Link to="#" className="text-white text-decoration-line">
                      {" "}
                      <u>drop</u>{" "}
                    </Link>{" "}
                    resume..
                ...
                <div className="box featured-jobs">
                  <div className="box-body">
                    ...
                    <div className="flex mb-4">
                      ...
                      <div className="ms-2">
                        <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                          <Link to="#"> HTML Developer - Fresher</Link>
                        </h5>
                    ...
                    <div className="popular-tags mb-4 space-x-1 rtl:space-x-reverse">
                      <Link
                        to="#"
                        className="badge rounded-pill bg-light text-default"
                      >
                ...
                <div className="box featured-jobs">
                  <div className="box-body">
                    ...
                    <div className="flex mb-4">
                      ...
                      <div className="ms-2">
                        <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                          <Link to="#"> React Lead Developer</Link>
                        </h5>
                ...
                <div className="box featured-jobs">
                  <div className="box-body">
                    ...
                    <div className="flex mb-4">
                      ...
                      <div className="ms-2">
                        <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                          <Link to="#"> Vuejs Frontend Developer</Link>
                        </h5>
                ...
                <div className="box featured-jobs">
                  <div className="box-body">
                    ...
                    <div className="flex mb-4">
                      ...
                      <div className="ms-2">
                        <h5 className="font-semibold mb-0 flex items-center text-[1.25rem]">
                          <Link to="#"> Wordpress Developer - Remote</Link>
                        </h5>
            ...
            <div className="grid grid-cols-12 items-center justify-center">
              ...
              <div className="md:col-span-8 col-span-12 my-6">
                <h2 className="font-semibold mb-4 text-[2rem] dark:text-defaulttextcolor/70">
                  ...
                  <Link to="#" className="text-primary text-decoration-line">
                    {" "}
                    <u>Publish</u>{" "}
                  </Link>{" "}
                  your job here..
