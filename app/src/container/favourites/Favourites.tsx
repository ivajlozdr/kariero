...
export default function Favourites() {
  ...
  const removeFromFavorites = (career: FullCareerDetails) => {
    toggleFavouriteOccupation(career, token, date, setFavouriteNotification);
    const code = career.occupation.code;
    setFavoritedCareers(
      favoritedCareers.filter(
        (state_career) => state_career.occupation.code !== code
      )
    );
  };
