...
export const sanitizeTranslation = (text: string): string => {
  ...
  const variantMap: { [normalizedKey: string]: string[] } = {
    "Професионален бакалавър": [
      "степента на сътрудник",
      "степен на сътрудник",
      "степен на сътрудника",
      "степен на сътрудникът",
      "сътрудническа степен"
    ],
    Доктор: ["докторска степен", "докторантура"],
    Магистър: ["магистърска степен"],
    Бакалавър: ["бакалавърска степен"],
    "Средно образование": ["гимназиална диплома или еквивалент"],
    "Основно образование": [
      "по -малко от гимназиалната диплома",
      "по-малко от гимназиалната диплома"
    ],
